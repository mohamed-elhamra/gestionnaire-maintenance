...
public class UserDto {
    ...
    @Size(min = 4, max = 50, message = "Username size should be between 4 and 50 character")
    private String username;

    @NotNull(message = "First name should not be null")
    @Size(min = 4, max = 50, message = "Firstname size should be between 4 and 50 character")
    private String firstName;

    @NotNull(message = "Last name should not be null")
    @Size(min = 4, max = 50, message = "Last name size should be between 4 and 50 character")
