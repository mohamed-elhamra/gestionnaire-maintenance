...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/users/*/anomalies")
                .hasAuthority(ERole.ROLE_MAINTENANCE_MANAGER.name())
                ...
                .antMatchers(HttpMethod.GET, "/resources/*")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/anomalies/*/close")
                .hasAuthority(ERole.ROLE_MAINTENANCE_MANAGER.name())
                .antMatchers(HttpMethod.POST, "/anomalies")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/anomalies/*")
                .permitAll()
